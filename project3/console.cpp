...
class Client : public enable_shared_from_this<Client>{
    public:
        ...
        id_(id){
            ...
            // cout << "<script>document.getElementById('test').innerHTML += '<b>file open success</b><br/>';</script>" << endl;
        }
    ...
    private:
        ...
        void do_read(){
            ...
            socket_.async_read_some(boost::asio::buffer(read_buffer, max_length), [this, self](const boost::system::error_code ec, size_t length){
                ...
                // else{
                //     cout << "<script>document.getElementById('test').innerHTML += '<b> do_read error "<< ec.message() <<"</b><br/>';</script>" << endl;
                // }
            });
        }
        ...
        void do_write(){
            auto self(shared_from_this());
            cmd = "";
            // cout << "<script>document.getElementById('test').innerHTML += '<b>do_write() getline() </b><br/>';</script>" << endl;
            getline(file, cmd);

            // cout << "<script>document.getElementById('test').innerHTML += '<b>" << cmd << "</b>';</script>" << endl;
